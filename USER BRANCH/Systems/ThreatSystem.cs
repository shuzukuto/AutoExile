    ...
    public class ThreatSystem
    {
        ...
        public void Tick(GameController gc)
        {
            ...
            foreach (var entity in gc.EntityListWrapper.OnlyValidEntities)
            {
                ...
                {
                    // Dodge window: [DodgeMinProgress, DodgeMaxProgress].
                    // Below DodgeMinProgress the destination isn't reliably locked yet.
                    // Above DodgeMaxProgress we're past the window — too late to meaningfully dodge.
                    // The consuming code (BossMode/SimMode) latches the signal and retries each tick
                    // until the blink fires or the window closes.
