...
namespace AutoExile.Systems
{
    ...
    public class InteractionSystem
    {
        ...
        public int MaxClickAttempts { get; set; } = 3;
        /// <summary>
        ...
        private const float TimeoutDirect = 2f; // seconds — short timeout for range clicks (2s max per in-range item)
        ...
        private InteractionResult TickGroundItem(GameController gc)
        {
            ...
            var labelEl = labelDesc.Label;
            if (labelEl == null || !labelEl!.IsVisible)
            {
